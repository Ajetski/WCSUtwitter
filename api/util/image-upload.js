...
module.exports = multer({
	storage: multer.diskStorage({
		destination: async function(req, file, cb) {
			...
			const username = req.body.user.username || req.params.username;
			const previous_path_base = path.resolve('uploaded_media', 'user_profile_pics', username);
			await fs.unlink(previous_path_base + '.png', () => {});
			await fs.unlink(previous_path_base + '_small.png', () => {});
